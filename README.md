<div align="center">
  ...
  <h1>@zitterorg/soluta-saepe</h1>
  <a href="https://www.npmjs.com/package/@zitterorg/soluta-saepe"><img src="https://img.shields.io/npm/v/@zitterorg/soluta-saepe.svg?style=flat&color=brightgreen" target="_blank" /></a>
...
> [!WARNING]
> You are looking at a pre-release version of @zitterorg/soluta-saepe, which adds support for msw v2. Documentation may be out of date and bugs might occur, use at your own risk
...
**1. Install `@zitterorg/soluta-saepe`.**

```bash
npm i @zitterorg/soluta-saepe --save-dev
```

**2. build your trpcMsw with createTRPCMsw.**

```typescript
import { createTRPCMsw } from '@zitterorg/soluta-saepe'
